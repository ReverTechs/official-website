...
export async function updateSession(request: NextRequest) {
  ...
  try {
    ...
    // If there's an error with Supabase (network issues, invalid config, etc.),
    // log it but don't block the request - allow the page to render
    console.error("Middleware error:", error);
    // Return the response to allow the page to load
    return supabaseResponse;
  }
